...
#    Updated: 2025/07/22 02:25:57 by pepealkalin      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = ft_ls

SRC = main.c utils.c print_large.c ft_printf/src/ft_printf.c ft_printf/src/ft_printf_utils.c sort.c parse_utils.c print_ls.c
